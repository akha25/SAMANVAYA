...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 selection:bg-blue-500/30">
      {/* Navigation */}
      <nav className="fixed top-0 w-full border-b border-slate-100 bg-[#F8FAFC]/80 backdrop-blur-md z-50">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="font-bold text-2xl tracking-tight text-slate-800">Samanvaya</div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-500">
            ...
            <a href="#ai-coach" className="hover:text-slate-800 transition-colors">AI Coach</a>
            <a href="#pricing" className="hover:text-slate-800 transition-colors">Pricing</a>
          </div>
          <div className="flex gap-4">
            <Link href="/login">
              <Button variant="ghost" className="text-slate-600 hover:text-slate-800">Sign In</Button>
            </Link>
            <Link href="/register">
              <Button className="bg-blue-600 hover:bg-blue-700 text-slate-800">Get Started</Button>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="container mx-auto text-center max-w-4xl mt-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/register">
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-slate-800 h-14 px-8 text-lg w-full sm:w-auto">
                Start Your Journey <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </Link>
            <Link href="/dashboard">
              <Button size="lg" variant="outline" className="border-slate-200 text-slate-600 hover:bg-slate-50 h-14 px-8 text-lg w-full sm:w-auto">
                View Live Demo
              </Button>
            </Link>
          </div>
      ...
      <section id="features" className="py-24 bg-white border-y border-slate-100">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">Replace six different apps with one unified platform designed to keep your holistic health in perfect sync.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-[#F8FAFC] border border-slate-100 hover:border-blue-500/50 transition-colors">
      ...
      <section id="how-it-works" className="py-24">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-1/2 left-[15%] right-[15%] h-0.5 bg-slate-50 -z-10"></div>
            {[
              ...
              <div key={s.step} className="text-center bg-[#F8FAFC] p-6">
                <div className="w-16 h-16 rounded-full bg-blue-600 text-slate-800 flex items-center justify-center text-2xl font-bold mx-auto mb-6 outline outline-8 outline-white">
                  {s.step}
                </div>
            ...
            <div className="lg:w-1/2 w-full max-w-md mx-auto">
              <div className="bg-white rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
                <div className="p-4 bg-slate-50 border-b border-slate-200 flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-slate-800">Aanya</div>
                    <div className="text-xs text-green-400">Online</div>
                  </div>
                </div>
                <div className="p-6 space-y-4 h-64 flex flex-col justify-end">
                  <div className="bg-blue-600 text-slate-800 p-3 rounded-2xl rounded-tr-sm self-end max-w-[80%] text-sm">
                    Can you suggest a high-protein dinner? I have 40g of protein and 400 calories left.
                  </div>
                  <div className="bg-slate-50 text-slate-800 p-3 rounded-2xl rounded-tl-sm self-start max-w-[90%] text-sm">
      ...
      {/* 6. Pricing */}
      <section id="pricing" className="py-24 bg-white border-y border-slate-100 text-center">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-4xl font-bold mb-6">100% Free to Start.</h2>
          <p className="text-xl text-slate-500 mb-10">We believe holistic health should be accessible to everyone. Join today and get full access to Diet Tracking, Workout Builder, and AI Coach Aanya.</p>
          <Link href="/register">
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-slate-800 h-14 px-12 text-lg">
              Create Free Account
            </Button>
          </Link>
        </div>
      ...
      <footer className="py-12 bg-[#F8FAFC] border-t border-slate-100">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="font-bold text-xl text-slate-800">Samanvaya</div>
          <div className="text-slate-400 text-sm">© 2026 Samanvaya Health Connect. All rights reserved.</div>
          <div className="flex gap-4">
            <a href="#" className="text-slate-500 hover:text-slate-800">Twitter</a>
            <a href="#" className="text-slate-500 hover:text-slate-800">Instagram</a>
            <a href="#" className="text-slate-500 hover:text-slate-800">Support</a>
          </div>
        </div>
      </footer>
    </div>
